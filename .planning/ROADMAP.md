...
**Plans**: 2 plans
Plans:
- [ ] 07-01-PLAN.md — FFI + bridge module: ghostty.h manual I/O fields, bridge.rs types, cmuxd-remote PTY spawn, tunnel.rs proxy routing
...
| 7. SSH Terminal I/O | 0/2 | Not started | - |
