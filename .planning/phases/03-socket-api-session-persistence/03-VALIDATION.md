...
| 3-SOCK-03 | 03-00 | 0 | SOCK-03 | unit | `cargo test session::tests::test_xdg_path_fallback` | ❌ W0 | ⬜ pending |
...
| 3-SOCK-05 | 03-00 | 0 | SOCK-05 | unit | `cargo test socket::tests::test_focus_policy` | ❌ W0 | ⬜ pending |
| 3-SOCK-06 | 03-01 | 1 | SOCK-06 | unit | `cargo test socket::auth::tests::test_peercred_rejection` | ❌ W0 | ⬜ pending |
| 3-SESS-01 | 03-00 | 0 | SESS-01 | unit | `cargo test session::tests::test_save_triggered` | ❌ W0 | ⬜ pending |
| 3-SESS-02 | 03-05 | 2 | SESS-02 | unit | `cargo test session::tests::test_restore_roundtrip` | ❌ W0 | ⬜ pending |
| 3-SESS-03 | 03-00 | 0 | SESS-03 | unit | `cargo test session::tests::test_atomic_write` | ❌ W0 | ⬜ pending |
| 3-SESS-04 | 03-00 | 0 | SESS-04 | unit | `cargo test session::tests::test_graceful_fallback` | ❌ W0 | ⬜ pending |
